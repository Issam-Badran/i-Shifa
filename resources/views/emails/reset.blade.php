...
<head>
  ...
  <title>إعادة تعيين كلمة المرور - i-Shifa</title>
</head>
...
" target="_blank" style="display: inline-block; padding: 16px 48px; color: #ffffff; font-size: 16px; font-weight: bold; text-decoration: none; border-radius: 12px;">
              ...
              <p style="color: #0d9488; font-size: 12px; word-break: break-all; text-align: center; margin: 0 0 24px; direction: ltr;">
                <a href="{{ $resetUrl }}
" target="_blank" style="color: #0d9488; text-decoration: underline;">{{ $resetUrl }}
</a>
              </p>
                ...
                <tr>
                  <td style="padding: 16px 20px;">
                    <p style="color: #92400e; font-size: 13px; line-height: 1.7; margin: 0; text-align: center;">
                      ⚠️ هذا الرابط صالح لمدة <strong>60 دقيقة</strong> فقط. إذا لم تطلب إعادة تعيين كلمة المرور، يمكنك تجاهل هذا البريد.
                    </p>
                  </td>
                </tr>
              </table>
